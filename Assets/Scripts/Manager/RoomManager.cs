...
public class RoomManager : MonoBehaviour {
    ...
    void Start() {
        ...
        roomObjects[0].setActive(true); // Activate the first room
        roomObjects[1].setActive(true); // Activate the second room
        roomObjects[2].setActive(true); // Activate the second room
